...
import { LIBRARY_COMPONENTS_MAP,_randomUid, _titleCase, createComponentsSchema } from "~/utils/meta";
  ...
  const context: ChatCompletionMessageParam[]= [
    ...
    },
    {
      ...
      content:
        ...
        json_query +
        "\n```\n\n" +
        `- The provided user query is an object on which the web component is based\n` +
        `- Look at the provided data, be creative and insightful, and identify what would be the purpose of the web component in this case - so you can come up with a relevant web component design\n` +
        `- Your task is to be highly creative, analytical and insightful, in order to design a web component that is relevant to the provided data\n` +
        `- Take a deep breathe, and think of a web component that would be relevant to provided object\n` +
